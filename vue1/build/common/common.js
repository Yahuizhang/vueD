...
/* WEBPACK VAR INJECTION */(function(__webpack_provided_window_dot_jQuery, __webpack_provided_window_dot_$, module) {var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/* NUGET: BEGIN LICENSE TEXT
 *
...
var _vuex = __webpack_require__(396);
...
exports.default = new _vuex2.default.Store({
  ...
  mutations: {
    userislogin: function userislogin(state, usertoken) {
      state.islogin = true;
      state.userinfo.username = usertoken.username;
      state.userinfo.userid = usertoken.id;
    },
    userisloginout: function userisloginout(state) {
      state.islogin = false;
    }
  }
});
...
/* WEBPACK VAR INJECTION */(function(jQuery, $) {/*  === common.js 全局变量===  */

/* ===通用变量===  */

var common_tools={
	version:'v1.0',
//	interfaceurl:'http://192.168.120.211:8050/b2b-web-front/',
// 	interfaceurl:'http://192.168.14.197/git/situation-awareness/src/json/',
//	interfaceurl:'http://192.168.0.4/vue/situationAwareness/src/json/',
//     interfaceurl:'http://www.tjqncxcyds.com/api.php',
    interfaceurl:'http://www.tjqncxcyds.com/api.php',
	// authcodeimgurl:'http://192.168.120.211:8050/b2b-web-front/login2/pcrimg',
	AJAX_callback:{},
	option:function(){
	...
	AJAX:function(_method,_url,_data,_success,_error){
		...
		$.ajax({
	        ...
	        data:JSON.stringify(_data), //转化为json字符串
...
module.exports = common_tools;
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(50), __webpack_require__(50)))
...
if(!(TO_PRIMITIVE in proto))__webpack_require__(15)(proto, TO_PRIMITIVE, __webpack_require__(176));
